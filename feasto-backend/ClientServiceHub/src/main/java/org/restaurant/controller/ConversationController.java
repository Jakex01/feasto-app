...
public class ConversationController {
    ...
    @GetMapping
    public ResponseEntity<List<ConversationResponse>> getAllConversationsByRestaurantAndUser(@RequestHeader(value = "Authorization") String token, @RequestParam Long restaurantId){
    ...
    @DeleteMapping
    public ResponseEntity<?> deleteConversationById(@RequestHeader(value = "Authorization") String token,@RequestParam Long conversationId){
